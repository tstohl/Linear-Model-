...
This model is better than thr one for GRIP. The Ajusted R-Square is bigger, which means more errors were reduced.
...
The models must be nested. That means all the independent variables in one model are also in the other models. SIMS is a function of ARM.
Model 2 is nested in model 3. Model 1 is nested in model 3. 
